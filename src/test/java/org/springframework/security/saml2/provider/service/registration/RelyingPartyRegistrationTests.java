...
public class RelyingPartyRegistrationTests {
	...
	public void withRelyingPartyRegistrationWorks() {
		RelyingPartyRegistration registration = TestRelyingPartyRegistrations.relyingPartyRegistration()
				...
				.assertingPartyDetails((a) -> a.artifactResolveServiceLocation("artifactres"))
	...
	private void compareRegistrations(RelyingPartyRegistration registration, RelyingPartyRegistration copy) {
		...
		assertThat(copy.getAssertingPartyDetails().getArtifactResolveServiceBinding())
		.isEqualTo(registration.getAssertingPartyDetails().getArtifactResolveServiceBinding());
		assertThat(copy.getAssertingPartyDetails().getArtifactResolveServiceLocation())
		.isEqualTo(registration.getAssertingPartyDetails().getArtifactResolveServiceLocation());
	}
