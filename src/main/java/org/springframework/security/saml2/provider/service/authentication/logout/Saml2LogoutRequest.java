...
public final class Saml2LogoutRequest implements Serializable {
	...
	private Saml2LogoutRequest(String location, Saml2MessageBinding binding, Map<String, Object> parameters, String id,
	...
	public String getSamlRequest() {
		return (String) this.parameters.get(Saml2ParameterNames.SAML_REQUEST);
	}
	 ...
	 * @return the signed and serialized &lt;saml2:LogoutRequest&gt; payload
	 */
	public XMLObject getXmlSamlRequest() {
		return (XMLObject) this.parameters.get(Saml2ParameterNames.SAML_REQUEST);
	}
	/**
	...
	public String getRelayState() {
		return (String) this.parameters.get(Saml2ParameterNames.RELAY_STATE);
	}
	...
	public String getParameter(String name) {
		...
		if (obj instanceof String) {
			...
			throw new ClassCastException(String.format("Parameter %s is instance of %s", name, obj.getClass().getName()));
		}
	}
	...
	public static final class Builder {
		 ...
		 */
		public Builder samlRequest(Object samlRequest) {
